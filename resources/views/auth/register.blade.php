                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="nisn" type="text" class="form-control" name="nisn" placeholder="10-11 Digit">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" required placeholder="contoh@contoh.com">
                        ...
                        <div class="form-group row">
                            <label for="opsi" class="col-md-4 col-form-label text-md-right">{{ __('Pilih Jenjang Tujuan') }}</label>
                            <div class="col-md-6">
